...
- Troca de senha
- Atribuição de perfil (role) ao usuário
...
- Validação de conflito de horário baseado na duração do serviço
...
- Um usuário só pode avaliar um barbeiro **uma única vez**
...
| `PATCH` | `/v1/user/{id}/assign-role` | Atribui um perfil ao usuário |
...
| Método | Endpoint | Descrição |
|---|---|---|
| `GET` | `/v1/review` | Lista todas as avaliações |
...
- Novo agendamento só pode ser feito após o **término do serviço anterior** do barbeiro, baseado na duração do serviço
...
### Usuários
- Perfis disponíveis: `CLIENT`, `BARBER`, `ADMIN`
